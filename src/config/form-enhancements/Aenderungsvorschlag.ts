// Auto-generated. Per-entity form-enhancements config for "Änderungsvorschlag".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["titel", "kategorie", "betroffener_bereich", "beschreibung", {"row": ["einreicher_vorname", "einreicher_nachname"]}, "einreicher_email", "einreichungsdatum", "prioritaet", "status", {"row": ["bearbeiter_vorname", "bearbeiter_nachname"]}, "umsetzungskommentar", "erledigungsdatum"],
  defaults: {
    'einreichungsdatum': { kind: 'today' },
